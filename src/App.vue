    ...
    <v-app>
            ...
            <v-container style="width: 100%; max-width: 464px; padding-top: 2em;">
                <router-link to="/">
                    <div style="display: flex; align-items: center;">
                        <img src="@/assets/appicon.png" alt="GitHub Dashboard App Icon"
                             style="height: 2.5em; margin-right: 0.5em; padding: 4px;">
                        <h2 class="text-center" style="opacity: 0.6;">GitHub Dashboard</h2>
                    </div>
                </router-link>
        ...
        <footer style="position: absolute; bottom: 0;  min-width: 100vw;">
            <v-container style="display: flex; justify-content: space-between;">
                <v-btn
                        href="https://github.com/qoomon/github-dashboard"
                        density="compact"
                        variant="text"
                        color="grey"
                        icon="mdi-github"
